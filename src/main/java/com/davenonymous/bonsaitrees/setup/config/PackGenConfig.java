...
public class PackGenConfig {
	...
	public PackGenConfig(ModConfigSpec.Builder builder) {
		...
		REMOVE_CACHE = builder
			...
			.translation("bonsaitrees4.configuration.packgen.remove_cache")
			.define("noCache", true);

		CREATE_ZIP = builder
			.comment("Create a zip file of the generated packs")
			.translation("bonsaitrees4.configuration.packgen.create_zip")
			.define("createZip", false);

		TRIM_TRUNKS = builder
			.comment("Trim trunks of trees to reduce height")
			.translation("bonsaitrees4.configuration.packgen.trim_trunks")
			.define("trimTrunks", true);

		TRIM_TRUNK_THRESHOLD = builder
			.comment("The height at which to trim trunks")
			.translation("bonsaitrees4.configuration.packgen.trim_trunk_threshold")
			.defineInRange("trimTrunkThreshold", 5, 1, 0xff);

		PATH = builder
			.comment("The path to save the generated packs")
			.translation("bonsaitrees4.configuration.packgen.path")
			.define("path", "bonsai-generated");

		MOD_BLACKLIST = builder
			.comment("Mods to exclude from pack generation")
			.translation("bonsaitrees4.configuration.packgen.mod_blacklist")
			.<String>defineListAllowEmpty(
				"modBlacklist", List.of("regions_unexplored"), String::new, p -> p instanceof String s && ModList.get().getModContainerById(s).isPresent());

		MAXIMUM_MODEL_BLOCKS = builder
			.comment("Maximum number of blocks during flood fill")
			.translation("bonsaitrees4.configuration.packgen.maximum_model_blocks")
		...
		MAXIMUM_MODEL_BLOCKSTATES = builder
			...
			.translation("bonsaitrees4.configuration.packgen.maximum_model_blockstates")
