...
import com.davenonymous.bonsaigen.setup.data.PoolType;
...
public class DGSaplingLootBuilder implements LootTableSubProvider {
	...
	public void generate(BiConsumer<ResourceKey<LootTable>, LootTable.Builder> consumer) {
		this.treeBlocks.forEach((saplingLocation, result) -> {
			...
			ResourceKey<LootTable> saplingLootTable = ResourceKey.create(Registries.LOOT_TABLE, BonsaiGen.bonsaiResource(newResourcePath));
